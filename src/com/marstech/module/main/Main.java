 ...
 */
package com.marstech.module.main;

import com.gn.GNAvatarView;
import com.marstech.global.plugin.ViewManager;
import com.marstech.global.factory.AlertCell;
...
public class Main implements Initializable {
    ...
    private String path = "/com/marstech/theme/css/";
...
//        drawer.setPopStylesheet(getClass().getResource("/com/marstech/theme/css/popover.css"));
    }
    ...
    private void addSubPop() throws Exception {
        popup.setContentNode(FXMLLoader.load(getClass().getResource("/com/marstech/module/main/Popover.fxml")));

//        popup.getRoot().getStylesheets().add(getClass().getResource("/com/marstech/theme/css/poplight.css").toExternalForm());
    ...
    private void addEvent(Node node) {
        ...
        scrollPane.getStylesheets().add(getClass().getResource("/com/marstech/theme/css/custom-scroll.css").toExternalForm());
...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void loadContentPopup(){
        try {
            popContent = FXMLLoader.load(getClass().getResource("/com/marstech/module/main/Config.fxml"));
            popConfig.getRoot().getStylesheets().add(getClass().getResource("/com/marstech/theme/css/poplight.css").toExternalForm());
    ...
    private void openMessages(){
        if(!pop.isShowing()){
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/marstech/module/media/man.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/marstech/module/media/woman.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/marstech/module/media/man.png").toExternalForm()));
            ...
            listView.getStylesheets().add(getClass().getResource("/com/marstech/theme/css/custom-scroll.css").toExternalForm());


            pop.getRoot().getStylesheets().add(getClass().getResource("/com/marstech/theme/css/poplight.css").toExternalForm());
    ...
    private void openNotification(){
      if(!pop.isShowing()){
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/marstech/module/media/warning-35.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/marstech/module/media/error-35.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/marstech/module/media/notification-35.png").toExternalForm()));
