 ...
 */
package com.marstech.module.loader;
...
public class Loader extends Preloader {
    ...
    public void init(){
        try {
            view = FXMLLoader.load(getClass().getResource("/com/marstech/module/loader/loader.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start(Stage primary){
        ...
        scene.getStylesheets().add(getClass().getResource("/com/marstech/theme/css/fonts.css").toExternalForm());
        progressBar = (JFXProgressBar) scene.lookup("#progressBar");
        primary.getIcons().add(new Image("/com/marstech/module/media/icon.png"));
