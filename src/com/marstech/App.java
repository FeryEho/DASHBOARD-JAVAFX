 ...
 *
 * www.marstech.co.id
 * Dilarang merubah atau memperjualkan program ini
 */

package com.marstech;

import com.marstech.global.User;
import com.marstech.global.UserDetail;
import com.marstech.global.Section;
import com.marstech.global.plugin.SectionManager;
import com.marstech.global.plugin.UserManager;
import com.marstech.global.plugin.ViewManager;
import com.gn.decorator.GNDecorator;
import com.gn.decorator.options.ButtonType;
import com.marstech.module.loader.Loader;
import com.marstech.module.main.Main;
...
//        decorator.fullBody();
    ...
    public  void start(Stage primary) {
        ...
        stylesheets.addAll(
                getClass().getResource("/com/marstech/theme/css/fonts.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/material-color.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/skeleton.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/light.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/bootstrap.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/shape.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/typographic.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/helpers.css").toExternalForm(),
                getClass().getResource("/com/marstech/theme/css/master.css").toExternalForm()
        );

        decorator.setMaximized(true);
        decorator.getStage().getIcons().add(new Image("/com/marstech/module/media/logo2.png"));
        decorator.show();
    ...
    private void load(String module, String name){
        try {
            ViewManager.getInstance().put(
                    name,
                    FXMLLoader.load(getClass().getResource("/com/marstech/module/" + module + "/" + name + ".fxml"))
            );
            preloaderNotify();
        } catch (IOException e) {
            e.printStackTrace();
