 ...
 */
package com.marstech.global.util;
    ...
    private static VBox createHeader(Type type){
        ...
        switch (type){
            case INFO:
                ...
                icon = new ImageView(new Image("/com/marstech/module/media/img/info_48dp.png"));
                break;
            case WARNING:
                color = Color.web("#FC6E51");
                icon = new ImageView(new Image("/com/marstech/module/media/img/warning_48dp.png"));
                break;
            case ERROR:
                color = Color.web("#ED5565");
                icon = new ImageView(new Image("/com/marstech/module/media/img/error_48dp.png"));
                break;
            case SUCCESS:
                color = Color.web("#02C852");
                icon = new ImageView(new Image("/com/marstech/module/media/img/done_48dp.png"));
                break;
        }
