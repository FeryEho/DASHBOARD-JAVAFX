...
public class UserDetail extends GNControl {
    ...
    @Override
    public Node icon() {
        Image image = new Image(getClass().getResource("/com/marstech/media/img/avatar.png").toExternalForm());
...
//        System.out.println(getName());
        ...
        gnAvatar.setImage(new Image(getClass().getResource("/com/marstech/media/img/avatar.png").toExternalForm()));
        ...
        popOver.getRoot().getStylesheets().add(getClass().getResource("/com/marstech/theme/css/poplight.css").toExternalForm());
